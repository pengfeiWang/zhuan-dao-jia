	...
	var Scroll = $.Class.extend({
		...
		_initEvent: function(detach) {
			...
			if(this.options.initCallBack){
				this.options.initCallBack.apply(this, arguments)
			}
		...
		_start: function(e) {
			...
			if( this.options.customStartCallBack ) {
				this.options.customStartCallBack.apply(this, arguments);
			}
			this.reLayout();
		...
		_drag: function(e) {
			...
			this.x = newX;
			this.y = newY;
			if(this.options.customMoveCallBack) {
				this.options.customMoveCallBack.apply(this, arguments)
			}
		...
		_updateTranslate: function() {
			...
			// if(self.options.customMoveCallBack) {
			// 	self.options.customMoveCallBack.apply(this, arguments)
			// }
...
(function($, window, document, undefined) {
	...
	var PullRefresh = $.Scroll.extend($.extend({
		...
		endPulldownToRefresh: function( callback ) {
			var self = this;
...
(function($, window) {
	...
	var Slider = $.Slider = $.Scroll.extend({
		...
		_triggerSlide: function() {
			...
			if( this.options.customEndCallBack ) {
				this.options.customEndCallBack.apply(this, arguments)
			}
		...
		_handleSlide: function(e) {
			...
			var detail = e.detail;
			var customIndicator = this.options.customIndicator
			...
			if (indicatorWrap) {
				// console.log(detail,detail.slideNumber)
